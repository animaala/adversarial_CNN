...
for i in range(nSteps):
    ...
    train_step.run(feed_dict={X: batch_xs, Y_: batch_ys, lr: 0.01, keep_prob: 0.75})
#    p.eval()
    ...
    if (i + 1) % 100 == 0:  # then perform validation
        ...
        train_accuracy = accuracy.eval(feed_dict={X: vbatch_xs, Y_: vbatch_ys, lr: 0.01, keep_prob: 0.75})
